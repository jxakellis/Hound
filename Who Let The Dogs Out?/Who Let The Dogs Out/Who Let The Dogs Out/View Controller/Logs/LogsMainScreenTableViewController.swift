...
class LogsMainScreenTableViewController: UITableViewController, DogManagerControlFlowProtocol {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print("num sections: \(uniqueLogDates.count)")
        for uniqueLogDatesIndex in 0..<uniqueLogDates.count{
            print("num rows in section \(uniqueLogDatesIndex): \(uniqueLogDates[uniqueLogDatesIndex].2.count)")
        }
    }
