...
class DogsInformationViewController: UIViewController {
    ...
    @IBOutlet private weak var purposeBody: ScaledUILabel!
    
    @IBOutlet private weak var howToUseBody: ScaledUILabel!
