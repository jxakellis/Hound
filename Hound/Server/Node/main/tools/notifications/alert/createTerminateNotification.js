...
const createTerminateNotification = async (userId) => {
  ...
  sendAPNForUser(userId, global.constant.apn.TERMINATE_CATEGORY, 'Oops, you may have terminated Hound!', "Your notifications won't ring properly if the app isn't running.", {});
};
