...
function createUserKickedNotification(userId) {
  ...
  sendAPNForUser(userId, global.constant.apn.category.GENERAL, 'You have been kicked', 'You are no longer a part of your Hound family. However, you can still create or join another family', {});
}
