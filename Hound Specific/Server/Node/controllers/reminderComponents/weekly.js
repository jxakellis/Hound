...
const createWeeklyComponents = async (req, reminderId) => {
    ...
    await queryPromise(req, 'INSERT INTO reminderWeeklyComponents(reminderId, hour, minute, sunday, monday, tuesday, wednesday, thursday, friday, saturday) VALUES (?,?,?,?,?,?,?,?,?,?)'
...
const updateWeeklyComponents = async (req, reminderId) => {
    ...
    try {
        ...
        if (skipping === true){
            await queryPromise(req, 'UPDATE reminderWeeklyComponents SET hour = ?, minute = ?, sunday = ?, monday = ?, tuesday = ?, wednesday = ?, thursday = ?, friday = ?, saturday = ?, skipping = ?, skipDate = ? WHERE reminderId = ?',
            [hour, minute, sunday, monday, tuesday, wednesday, thursday, friday, saturday, skipping, skipDate, reminderId])
        }
        else {
            await queryPromise(req, 'UPDATE reminderWeeklyComponents SET hour = ?, minute = ?, sunday = ?, monday = ?, tuesday = ?, wednesday = ?, thursday = ?, friday = ?, saturday = ?, skipping = ? WHERE reminderId = ?',
