...
class WeeklyComponents: Component, NSCoding, NSCopying, GeneralTimeOfDayProtocol {
    ...
    convenience init(parentReminder: Reminder, hour: Int?, minute: Int?, skipping: Bool?, skipDate: Date?, sunday: Bool?, monday: Bool?, tuesday: Bool?, wednesday: Bool?, thursday: Bool?, friday: Bool?, saturday: Bool?) {
        self.init()
