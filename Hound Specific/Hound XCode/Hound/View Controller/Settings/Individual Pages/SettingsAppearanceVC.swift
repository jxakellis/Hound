...
class SettingsAppearanceViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    @IBAction private func didUpdateInterfaceStyleSegmentedControl(_ sender: Any) {
        ...
        let currentInterfaceStyle = UserConfiguration.interfaceStyle
        ...
        UserRequest.update(body: [UserDefaultsKeys.interfaceStyle.rawValue: convertedInterfaceStyleRawValue!]) { _, responseCode, _ in
            DispatchQueue.main.async {
                ...
                // error, revert to previous
                    ...
                    // revert all values
                    UIApplication.keyWindow?.overrideUserInterfaceStyle = currentInterfaceStyle
                    UserConfiguration.interfaceStyle = currentInterfaceStyle
                    switch UserConfiguration.interfaceStyle.rawValue {
                    // system/unspecified
                    case 0:
